...
define("esri/tasks/PrintTask", ["dijit","dojo","dojox","dojo/require!esri/tasks/_task,esri/tasks/gp"], function(dijit,dojo,dojox){
dojo.provide("esri.tasks.PrintTask");

dojo.require("esri.tasks._task");
dojo.require("esri.tasks.gp");

dojo.declare("esri.tasks.PrintTask", esri.tasks._Task, {
  ...
  _createOperationalLayers: function (map) {
    var i, layer, layerType, opLayer, opLayers = [];
    if (this.legendAll) {
