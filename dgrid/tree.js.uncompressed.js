//>>built
define("dgrid/tree", ["dojo/_base/declare", "dojo/_base/Deferred", "dojo/query", "dojo/on", "dojo/aspect", "dojo/has!touch?./util/touch", "put-selector/put"],
function(declare, Deferred, querySelector, on, aspect, touchUtil, put){

dojo.getObject("dgrid.tree", true);
return (dgrid.tree = function(column){
	// summary:
